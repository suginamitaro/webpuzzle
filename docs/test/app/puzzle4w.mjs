...
export function getsample(array, n, rand) {
...
export function uniqPush(array, element) {
    if (!array.includes(element)) {
        array.push(element);
    }
}

export function uniqAppend(array1, array2) {
    var result = Array();
...
export function getRandomNArray(str1, str2, n, rand) {
...
export function getHintArray(answer, ans_array, hints, word_count, size, rand) {
    var str = "" + answer;
...
export function makeHistorySpan(length, line) {
    var result = "";
...
export function makeHintSpan(hint_ar, br_pos, callbackstr, vline) {
    var result = "";
    var line = 0;
...
export function check_answer(instr, answer) {
    var result = {};
    result.resstr = "";
    result.match = [];
    result.hit = [];
...
export function allsame(str,cha) {
...
export function makeClipStr(title, histtry, tourl) {
...
export function formatTime(basesec) {
...
export function nokori(date, option) {
    var result = {};
